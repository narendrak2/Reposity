...
import Libraryfiles.Testbase;
	...
	public class Logintest extends Testbase{
		...
		public void validatepagetitle() {
			...
			AssertJUnit.assertEquals(tilte,"Self Drive Car Rentals in Bangalore | Rent a car in Bangalore | Drivezy");
		}
		...
		public void logincheckpass() throws InterruptedException {
			...
			AssertJUnit.assertEquals(str, "Login/SignUp");
			...
			AssertJUnit.assertEquals(str1, "Login Successful.");
		}
		...
		public void logincheckfail() throws InterruptedException {
			...
			AssertJUnit.assertEquals(str1, "Login Failed");
		}
